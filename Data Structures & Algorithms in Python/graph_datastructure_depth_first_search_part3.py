class Graph:
    ...
    def search_target_using_dfs_recursive(self, source, target, visited=None):
        if visited is None:
            visited = set()
        ...
        for neighbor in self.graph[source]:
            if neighbor not in visited:
                if self.search_target_using_dfs_recursive(neighbor, target, visited):
                    return True
...
if __name__ == "__main__":
    ...
    dg.search_target_using_dfs_recursive(1,9)
